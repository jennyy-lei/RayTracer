...
white_light = gr.point_light({0, 10, 5}, {0.7, 0.7, 0.7}, {1, 0, 0})
blue_light = gr.point_light({-5, 10, 0}, {0.7, 0.7, 0.8}, {3, 0, 0})
warm_light = gr.point_light({5, 10, 0}, {0.8, 0.7, 0.7}, {3, 0, 0})

gr.render(scene, 'demo/bumpmap2png', 1024, 512,
	  {0, 0.5, 8}, {0, 0, -8}, {0, 1, 0}, 50,
